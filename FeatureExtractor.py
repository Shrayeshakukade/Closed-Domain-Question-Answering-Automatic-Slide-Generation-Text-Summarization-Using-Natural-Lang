...
if __name__ == '__main__':
    sentence = "A computer processor platform consists of a collection of hardware resources, such as the , main memory, I/O modules, timers, disk drives, and so on. This is a sub sentence. Computer processor requires high bandwidth to improve prformance." #dummy sentence
