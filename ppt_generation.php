...
<?php
    ...
    if(isset($_POST['upload']))
    {
        ...
        $file_store = "upload_files/".$file_name;
...
function button2() {
  ...
  $myfile = fopen("titlefile.txt", "w") or die("Unable to open file!");
  fwrite($myfile, $title);
  $process_status = 1;
  $output_path_download = 'C:\Users\A\Downloads\GeneratedPPTs\generated_'.$title;
  $command_exec = escapeshellcmd("python C:/xampp/htdocs/BE_Project/BE_Project/Driver.py -O $output_path_download -P 1");
  $str_output = shell_exec($command_exec);
  #echo $str_output;
  echo "<br>";

$path = 'C:/Users/A/Downloads/GeneratedPPTs';
$path2 = 'generated_'.$title.'.pptx';
$files = scandir($path);
...
if ($flag == 1){
  echo "<strong>PPT generated! Please go to your downloads!</strong>";
}
else{
  echo "<strong>Format not supported!</strong>";
}
